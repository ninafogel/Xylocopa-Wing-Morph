...
#save(rasterList_Morph, file = 'output/morphoutput0324.rda')

load('output/morphoutput0324.rda')
...
#save(rasterList_NM, file = 'output/nonmorphoutput0324.rda')

load('output/nonmorphoutput0324.rda')
